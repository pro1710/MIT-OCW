...
transitive_rule = IF( AND('(?y) beats (?x)',
                          '(?z) beats (?y)'),
                  THEN('(?z) beats (?x)') )
...
same_males = IF ('male (?x)',
             THEN ('same (?x) (?x)')
)

same_females = IF ('female (?x)',
             THEN ('same (?x) (?x)')
)
...
father = IF( AND('male (?x)',
                 'parent (?x) (?y)'),
                 THEN('father (?x) (?y)')
)

mother = IF( AND('female (?x)',
                 'parent (?x) (?y)'),
                 THEN('mother (?x) (?y)')
)
...
daughter = IF( AND('female (?x)',
              'parent (?y) (?x)'),
              THEN('daughter (?x) (?y)')
)

cousin = IF( AND( OR('brother (?a) (?b)',
                     'sister (?a) (?b)'),
                'parent (?a) (?x)',
                'parent (?b) (?y)'),
                 THEN('cousin (?x) (?y)'))
